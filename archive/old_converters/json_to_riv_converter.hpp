#ifndef JSON_TO_RIV_CONVERTER_HPP
#define JSON_TO_RIV_CONVERTER_HPP
...
public:
    ...
    // Export methods
    std::vector<uint8_t> exportToBytes();
    bool saveToFile(const std::string& filepath);
};

#endif // JSON_TO_RIV_CONVERTER_HPP
